...
def fig_dirs(remove_ped, optima_iterate_diag, tol, \
             ess_off_diag, ess_num_peds, ess_boost, \
  ...
  if os.path.exists(str(home_dir)+'/results/igp/plots/eth/\
...
'_goal_noise_' + str(goal_noise))==False:
    ...
    os.mkdir(str(home_dir)+'/results/igp/plots/eth/\
agent_' + str(remove_ped) + \
'_optima_iter_'+ str(optima_iterate_diag) + \
'_tol_' + str(tol) + \
'_ess_off_diag_' + str(ess_off_diag) + \
...
'_goal_noise_' + str(goal_noise))
  ...
  os.chdir(str(home_dir)+'/results/igp/plots/eth/\
agent_' + str(remove_ped) + \
'_optima_iter_'+ str(optima_iterate_diag) + \
'_tol_' + str(tol) + \
'_ess_off_diag_' + str(ess_off_diag) + \
