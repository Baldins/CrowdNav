...
from crowd_sim.envs.policy import igp_fun, igp_dist
from crowd_nav.policy.cadrl import CADRL



class MultiHumanRL_igp(CADRL):
    def __init__(self):
        super().__init__()
    ...
    def predict(self, state):
        ...
        if self.action_space is None:
            build_action_space(state.self_state.v_pref)
        ...
        if self.phase == 'train' and probability < self.epsilon:
            ...
            for action in self.action_space:
                ...
                if self.query_env:
                    ...
                    # next_human_states, reward, done, info = self.env.onestep_lookahead(action, non_attentive_humans)
